 ...
 */
public class MyDateFormatDetector extends Detector implements SourceCodeScanner {

    private static final Implementation IMPLEMENTATION = new Implementation(
            MyDateFormatDetector.class,
    ...
    /**
     * Constructs a new {@link MyDateFormatDetector}
     */
    public MyDateFormatDetector() {
    }
